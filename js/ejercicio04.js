...
// console.log(numOrdenados);  // Imprime el arreglo con los números ya ordenados de menor a mayor

let mediana = 0;
if (numOrdenados.length%2==0){
    // console.log('par');  // Imprime si el número es par o impar
    const ind1 = numOrdenados.length / 2 -1;
    const ind2 = ind1+1;
   // console.log(ind1, ind2); // Imprime las posiciones de los números para tomar la mediana
    ...
    // console.log(mediana); // imprime la mediana
} else {
    console.log('impar');
